...
class Model:
    ...
    def busqueda_articulo_gerente(self,request):
        ...
        if not request.form:
            actualizador={'nombre': '','precio_mayor': None,'precio_menor': None,'material': ''
            ,'proveedor': '','proveedor_direccion': '',
            'cantidad_mayor': None,'cantidad_menor': None}
        else:
        ...
        if not request.form['precio_mayor']:
            actualizador['precio_mayor']=None
        if not request.form['precio_menor']:
            actualizador['precio_menor']=None
        if not request.form['cantidad_mayor']:
            actualizador['cantidad_mayor']=None
        if not request.form['cantidad_menor']:
            actualizador['cantidad_menor']=None
        cur.execute(query,actualizador)
        print(actualizador)
        data = []
        contenido = {}
